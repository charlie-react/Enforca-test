...
return(
    <div className="mx-auto flex gap-2 text-sm items-center justify-center mb-3">
       <div className="relative">
        ...
        <input placeholder="Search" type="text" className="p-2 w-60 md:w-100 rounded-md border-2 focus:outline-none pl-8 border-gray-300"/>
       </div>
        <div className="flex gap-2 p-2 border-2 border-gray-300 rounded-md cursor-pointer">
